  ...
  <<
    \new PianoStaff <<
      \new Staff = "RH" {
        ...
        << {a'16 g'-4 fis' e'-2 d'8^\markup { \finger "1 - 5" } r r4}\\{r16 e' d'  cis'-2 b-1  a g e-2 fis[ g-1 a b]} >> | % 10
        << {r8 cis''~ cis''16[ b'-3 a' b'] cis''[ d''-1 e''-3 fis'']}\\{cis'16 d'-1 e' fis' g'8-1 r r4} >> | % 11
        << {g''8 g'16 fis'-4 g'4~ g'16^\markup { \finger "5 - 4" }[ b' a' g'-1]}\\{r8  a~ a16  b-1 cis'-3 b a  g fis e-1} >> | % 12
        ...
        << {g'4.^\markup { \finger "2 - 5" } fis'8 e'16-3 a' g'8~}\\{fis'8  g-2 a-1  b-1 cis'-2  e-1} >> | % 15
        ...
        << {d''8^\markup { \finger "4 - 5" } r r4 r}\\{r16  a' gis'-3 fis' gis'[ f'-2 e' d'-3] e'[ d' c' b]} >> | % 26
        << {r16[ c'-1 d' e'] d'[ ees' fis' g'] fis'-2[ g' a' b']}\\{c'2.~} >> | % 27
        << {a'2.~^\markup { \finger "4 - 5" }}\\{c'8 g' fis' e'-1 d'16-2[ b c' a]} >> | % 28
      ...
      \new Staff = "LH" {
        ...
        << {r8 e fis g-5 a b^\markup { \finger "3 - 4" }}\\{e'2.~-4} >> | % 21
