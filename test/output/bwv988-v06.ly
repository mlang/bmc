    ...
    \new PianoStaff <<
      \new Staff = "RH" {
        ...
        \repeat volta 2 {
          ...
          << {c''4.~^\markup { \finger "3 - 5" }}\\{b'8 a'16-2 g' fis'-3 e'} >> |
          << {c''8 b'16-4 a'-5 g' fis'}\\{d'4.~} >> |
          << {e'4.~^\markup { \finger "2 - 5" }}\\{d'8 c'16-2 b a-2 g} >> |
          << {e'8 d'16 c'-5 b a-3}\\{a4.~} >> |
          << {b4.~}\\{a16[ g-1 b-5 a g fis]} >> |
          << {b16[ a-1 c'-2 b a-2 g]}\\{g8-3 g'4~} >> |
          << {a8^\markup { \finger "2 - 1" } a'4~}\\{g'8^\markup { \finger "5 - 4" } fis'16 e' d' c'-2} >> |
        ...
        \repeat volta 2 {
          ...
          << {fis'4.~^\markup { \finger "4 - 5" }}\\{e'16[ dis'-3 cis' e' dis' cis']} >> |
