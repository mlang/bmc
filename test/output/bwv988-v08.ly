  ...
  <<
    \new PianoStaff <<
      \new Staff = "RH" {
        ...
        \key g \major
        \time 3/4
        d'16-1[ g'-2 b' a'] g'-1[ b'-2 d'' c''] b'-1 d'' g'' r | % 1
        d'16[ fis'-2 a' g'] fis'[ a'-3 c'' b'] a'-1 d'' fis'' r | % 2
        b16[ d'-2 g' fis'] e'-1[ g' b' a'] g'-1 cis'' e'' r | % 3
        a16[ d' fis' e'] d'-1[ fis' a' g'] fis' a' d''8~ | % 4
        d''16[ b'-3 g' a'-4] b'[ g' d' e'-3] f' d' b r | % 5
        e''16-5[ c'' a' b'] c''[ a' e' fis'] g' e' c' r | % 6
        a''16[ fis'' d'' e''-3] fis''[ d'' a' b'-4] c''[ a' fis' c''] | % 7
        b'16[ g' d' fis'-4] g'[ d' b c'-3] d'[ b g a] | % 8
        b8 b''16-5 a'' g''[ fis'' e'' d''-3] cis''[ e'' d'' e''] | % 9
        ...
        e''16[ c'' a'-1 b'-4] c''[ a' fis'-2 g'] a'[ fis' dis' e'-3] | % 19
        ...
        fis''16[ a'' c''' b''] a''[ g''-1 fis''-3 e''] d''[ fis'' a'' c'''] | % 28
        b''16[ d''' g''-2 a''] b''[ g'' d'' e''-3] f''[ d'' b' d''] | % 29
        e''16[ g'' c'' d''-3] e''[ c'' a' b'-4] c''[ a' e' g'] | % 30
      ...
      \new Staff = "LH" {
        ...
        e16-5[ g b a-3] g[ b e' d'-3] cis'[ e' g' fis'-3] | % 11
        e'16[ g' cis''-1 b'-3] a'[ cis'' e'' d''-3] cis''[ e'' a'' g''] | % 12
        fis''16[ a'' d''-4 e''] fis''-2[ d''-3 a' b'-3] c''[ a' fis' a'-3] | % 13
