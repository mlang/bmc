  ...
  <<
    \new PianoStaff <<
      \new Staff = "RH" {
        ...
        << {g'4. g''~ g''8^\markup { \finger "5 - 4" } a''16 g'' fis'' g'' a''8 r r}\\{b'4.~-2 b'16[ c''-1 d''-3 c'' d'' e''] a'4.~ a'16[ b' c'' b' c'' d'']} >> | % 2
        << {r8 d''16-5 c'' b' a' b'8-1 c''16-3 b' a' b' g'8 e''-3 d''^\markup { \finger "1 - 2" } c'' fis'' a''}\\{g'4. g''~-5 g''8^\markup { \finger "5 - 4" } a''16 g'' fis''-3 g'' a''8 r r} >> | % 3
        << {b'4-1 g''8 g''4 fis''8 r r b'' a''4^\markup { \finger "4 - 5" } d''8~-2}\\{r8 d''16-4 c'' b' a' b'8 c''16-1 b'-2 a' b' g'8 e''-3 d''-2 c'' fis''-4 a''-5} >> | % 4
        << {d''16 e''-4 d'' c'' b'8 e'' b' d''^\markup { \finger "2 - 1" } cis'' d'' e''~^\markup { \finger "2 - 1" } e'' cis''-2 a'}\\{b'4 g''8 g''4 fis''8 r r b'' a''4^\markup { \finger "4 - 5" } d''8~} >> | % 5
        << {r8 r d''-4 g'4.~ g'8 fis'-1 g'^\markup { \finger "1 - 2" } e' a'16 g' fis'-2 e'}\\{d''16 e'' d'' c''-1 b'8 e'' b' d''-4 cis'' d'' e''~ e'' cis'' a'-3} >> | % 6
        ...
        << {r4. a'~ a'8 b'16-3 a' g' fis' g'-1[ a' b' g' a' b']}\\{e''8 fis'' g''~ g'' fis'' e''-5 dis''4.~^\markup { \finger "4 - 5" } dis''4 r8} >> | % 11
        ...
        << {a''8 g''-4 f''-5 e''16[ d'' c'' e''-5 d'' c''] b'4^\markup { \finger "2 - 1" } b''8 a''4 c'''8}\\{b'16[ c''-1 d''-2 b' c'' d''] g'4.~ g'8 g''4~^\markup { \finger "5 - 3" } g''8 fis'' a''~-3} >> | % 15
