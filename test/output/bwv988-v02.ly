    ...
    \new PianoStaff <<
      \new Staff = "RH" {
        ...
        \repeat volta 2 {
          ...
          << {e'4~^\markup { \finger "3 - 4" } e'16[ g' fis' e']}\\{d'16[ cis' b d'] cis'4} >> |
        }
        \alternative {
          {<d' d'>8 r r4  | }
          {<d' d'>4 r | }
        ...
        \repeat volta 2 {
          ...
          << {fis'4~^\markup { \finger "3 - 4" } fis'16[ a' g' fis']}\\{e'16[ dis'-2 cis' e'] dis'4} >> |
          << {g'4 r}\\{e'4 b'~-5} >> |
          << {e'4 a'~}\\{b'16[ a' g' b'] a'[ g'-1 fis'-3 e']} >> |
          << {a'16[ g' fis' a'-5] g'[ fis' e'-1 d'-2]}\\{d'4 g'~} >> |
          << {c'4 c''~}\\{g'16[ fis' e' g'-3] fis'[ e' d'-2 c']} >> |
          << {c''16[ b' a' c''] b'[ a' g'-1 fis'-2]}\\{d'4^\markup { \finger "2 - 1" } r} >> |
          << {b'8-4 g'-1 b'-2 d''-1}\\{d''4^\markup { \finger "5 - 4" } f''~^\markup { \finger "5 - 3" }} >> |
          << {g''4^\markup { \finger "4 - 3" } c'''~}\\{f''16[ e'' d'' f''-2] e''[ g'' fis'' g''-1]} >> |
