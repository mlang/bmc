  ...
  <<
    \new PianoStaff <<
      \new Staff = "RH" {
        ...
        d'''16 a'' a''32-4 gis'' a''16 d''4~^\markup { \finger "1 - 5" } | % 4
        d''8 ees''16-4( f'') ees''[( d'') d''-4( c'']) | % 5
        bes'8-5 r r c''-1 | % 6
        g''32-3 a'' fis''16 g'' a''-1 bes''[ c''' d''' c'''-1] | % 7
        bes''16-4 \appoggiatura a''8 g''16 d''8~^\markup { \finger "1 - 4" } d'' ees'' | % 8
        d''8 r r16[ ees'' d''-4 c''] | % 9
        bes'16[( c'') c''-3( d'']) d''-3[ ees'' ees'' d''] | % 10
        d''8-5 r r a''-4 | % 11
        bes''8 d''16-2 e''~ e'' f''8^\markup { \finger "4 - 3" } g''16 | % 12
        a''8 bes'-2 c''-1 a'' | % 13
        ...
        << {g''16 g'8-1 aes'16~-3 aes' bes'8 c''16-5}\\{bes'8^\markup { \finger "2 - 4" } ees'-2 d' g'-3} >> | % 19
        << {bes'8^\markup { \finger "4 - 3" } f''^\markup { \finger "5 - 4" } g'' d''-3}\\{f'16-2 g'-1 aes'8^\markup { \finger "2 - 1" } r16 bes'8-2 aes'16} >> | % 20
        ...
        << {bes'16^\markup { \finger "5 - 3" } c''32-1 d'' ees'' d'' c''16 d'' ees''32 f'' ees'' f'' g''16}\\{ ees'8-1 r r4} >> | % 24
        ...
        << {g'8.-4 a'16 bes'-3[ c'' d'' e''-4]}\\{ees'16[ d'^\markup { \finger "1 - 2" } c' ees'] d' e' fis'32 g'-1  a16~-2} >> | % 30
      ...
      \new Staff = "LH" {
        ...
        \time 2/4
        g8 g, r g~-3 | % 1
        << {g16 fis32 e fis8 r d}\\{d'4~ d'16[ c'^\markup { \finger "2 - 1" } bes a-1]} >> | % 2
        ...
        << {f32-3 e d16 g4^\markup { \finger "3 - 4" } fis8}\\{r8 d'32 cis' d'16~ d' d'8 d'16~} >> | % 13
