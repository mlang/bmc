...
private:
  void reset_memory()
  {
    for (std::size_t octave = 0; octave < 10; ++octave) {
      ...
      switch (key_sig) {
      case  14: memory[octave][B] = double_sharp; if (not --count) break; [[clang::fallthrough]];
      case  13: memory[octave][E] = double_sharp; if (not --count) break; [[clang::fallthrough]];
      case  12: memory[octave][A] = double_sharp; if (not --count) break; [[clang::fallthrough]];
      case  11: memory[octave][D] = double_sharp; if (not --count) break; [[clang::fallthrough]];
      case  10: memory[octave][G] = double_sharp; if (not --count) break; [[clang::fallthrough]];
      case   9: memory[octave][C] = double_sharp; if (not --count) break; [[clang::fallthrough]];
      case   8: memory[octave][F] = double_sharp; if (not --count) break; [[clang::fallthrough]];

      case   7: memory[octave][B] = sharp;        if (not --count) break; [[clang::fallthrough]];
      case   6: memory[octave][E] = sharp;        if (not --count) break; [[clang::fallthrough]];
      case   5: memory[octave][A] = sharp;        if (not --count) break; [[clang::fallthrough]];
      case   4: memory[octave][D] = sharp;        if (not --count) break; [[clang::fallthrough]];
      case   3: memory[octave][G] = sharp;        if (not --count) break; [[clang::fallthrough]];
      case   2: memory[octave][C] = sharp;        if (not --count) break; [[clang::fallthrough]];
      case   1: memory[octave][F] = sharp;        if (not --count) break; [[clang::fallthrough]];

      case   0: break;

      case -14: memory[octave][F] = double_flat; if (not --count) break; [[clang::fallthrough]];
      case -13: memory[octave][C] = double_flat; if (not --count) break; [[clang::fallthrough]];
      case -12: memory[octave][G] = double_flat; if (not --count) break; [[clang::fallthrough]];
      case -11: memory[octave][D] = double_flat; if (not --count) break; [[clang::fallthrough]];
      case -10: memory[octave][A] = double_flat; if (not --count) break; [[clang::fallthrough]];
      case  -9: memory[octave][E] = double_flat; if (not --count) break; [[clang::fallthrough]];
      case  -8: memory[octave][B] = double_flat; if (not --count) break; [[clang::fallthrough]];

      case  -7: memory[octave][F] = flat;        if (not --count) break; [[clang::fallthrough]];
      case  -6: memory[octave][C] = flat;        if (not --count) break; [[clang::fallthrough]];
      case  -5: memory[octave][G] = flat;        if (not --count) break; [[clang::fallthrough]];
      case  -4: memory[octave][D] = flat;        if (not --count) break; [[clang::fallthrough]];
      case  -3: memory[octave][A] = flat;        if (not --count) break; [[clang::fallthrough]];
      case  -2: memory[octave][E] = flat;        if (not --count) break; [[clang::fallthrough]];
