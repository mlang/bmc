...
#include <bmc/braille/parser/ast.hpp>
...
#define SIMPLE_BASE(NAME, CLASS, VAR)                                                  \
  ...
  bool walk_up_from_note(Ref<ast::note> n) {
    return derived().walk_up_from_rhythmic(
           ...
           derived().walk_up_from_position_tagged(static_cast<Ref<ast::position_tagged>>(n)) &&
  ...
  bool walk_up_from_rest(Ref<ast::rest> r) {
    return derived().walk_up_from_rhythmic(
           ...
           derived().walk_up_from_position_tagged(static_cast<Ref<ast::position_tagged>>(r)) &&
  ...
  SIMPLE_BASE(position_tagged, ast::position_tagged, l)
  ...
  bool walk_up_from_chord(Ref<ast::chord> c) {
    return derived().walk_up_from_position_tagged(static_cast<Ref<ast::position_tagged>>(c)) &&
  ...
  bool walk_up_from_moving_note(Ref<ast::moving_note> mn) {
    return derived().walk_up_from_position_tagged(static_cast<Ref<ast::position_tagged>>(mn)) &&
